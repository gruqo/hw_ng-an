...
Блок в ```/etc/angie/angie.conf``` для автоматизированного добавления списка модулей при установке.  
В таске генерации блока отфильтровывались модули с постфиксом ```-debug```. В итоговом конфиге они остутсвуют.    
