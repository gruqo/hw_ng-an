...
![Скрин](images/v_01/common/architecture_01.png)  
<br>
...
![Скрин](images/v_01/common/angie_version.png)  
<br>


[Конфигурация Angie](solution/src/v_01/angie/conf/prod_angie-pro.conf)  
[Конфигурация виртуальных серверов](solution/src/v_01/angie/conf/virt_servers/prod_hw16.conf)  
...
![Скрин](images/v_01/common/angie_tls-sert_ecdsa.png)  
<br><br>
...
![Скрин](images/v_01/rr-d_backend+all_be.png)  
<br>

Результат выполнения команды в терминале  
![Скрин](images/v_01/rr-c_backend+all_be.png)  
<br>

Страница мониторинга  
![Скрин](images/v_01/rr-p_backend+all_be.png)  
<br>


Из балансировки выведен backend1 (трафик поступает на backend2 и backend3)  
Работающие контейнеры  
![Скрин](images/v_01/rr-d_backend-1_be.png)  
<br>

Результат выполнения команды в терминале  
![Скрин](images/v_01/rr-c_backend-1_be.png)  
<br>

Страница мониторинга  
![Скрин](images/v_01/rr-p_backend-1_be.png)  
<br>


Из балансировки выведен backend1 и backend2 (трафик поступает на backend3)  
Работающие контейнеры  
![Скрин](images/v_01/rr-d_backend-1-2_be.png)  
<br>

Результат выполнения команды в терминале  
![Скрин](images/v_01/rr-c_backend-1-2_be.png)  
<br>

Страница мониторинга  
![Скрин](images/v_01/rr-p_backend-1-2_be.png)  
<br>


Из балансировки выведен backend1, backend2 и backend3 (трафик поступает на backup)  
Работающие контейнеры  
![Скрин](images/v_01/rr-d_backend-1-2-3_be.png)  
<br>

Результат выполнения команды в терминале  
![Скрин](images/v_01/rr-c_backend-1-2-3_be.png)  
<br>

Страница мониторинга  
![Скрин](images/v_01/rr-p_backend-1-2-3_be.png)  
<br>


В балансировку введен backend1 (трафик поступает на backend1)  
Работающие контейнеры  
![Скрин](images/v_01/rr-d_backend-2-3_af.png)  
<br>

Результат выполнения команды в терминале  
![Скрин](images/v_01/rr-c_backend-2-3_af.png)  
<br>

Страница мониторинга  
![Скрин](images/v_01/rr-p_backend-2-3_af.png)  
<br>

3 сервера бэкенда активны (трафик поступает на backend1, backend2 и backend3)  
Работающие контейнеры  
![Скрин](images/v_01/rr-d_backend+all_af.png)  
<br>

Результат выполнения команды в терминале  
![Скрин](images/v_01/rr-c_backend+all_af.png)  
<br>

Страница мониторинга  
![Скрин](images/v_01/rr-p_backend+all_af.png)  
<br><br>
...
Результат выполнения команды в терминале  
![Скрин](images/v_01/h-c_backend+all_Chrome_be.png)  
<br>

Страница мониторинга  
![Скрин](images/v_01/h-p_backend+all_Chrome_be.png)  
<br>
...
Результат выполнения команды в терминале  
![Скрин](images/v_01/h-c_backend+all_Mozilla_be.png)  
<br>

Страница мониторинга  
![Скрин](images/v_01/h-p_backend+all_Mozilla_be.png)  
<br>
...
Результат выполнения команды в терминале  
![Скрин](images/v_01/h-c_backend+all_Safari_be.png)  
<br>

Страница мониторинга  
![Скрин](images/v_01/h-p_backend+all_Safari_be.png)  
<br><br>
...
Результат выполнения команды в терминале  
![Скрин](images/v_01/r-c_backend+all_be.png)  
<br>

Страница мониторинга  
![Скрин](images/v_01/r-p_backend+all_be.png)  
<br><br>
